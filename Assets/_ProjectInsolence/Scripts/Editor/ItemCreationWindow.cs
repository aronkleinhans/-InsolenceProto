...
namespace Insolence.Core
{
    public class ItemCreationWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            {
                string folderPath = "Assets/_ProjectInsolence/Scripts/InventorySystem/Items/Items/ScriptableObjects/" + newItem.type.ToString() + "/";

                Debug.Log(folderPath);

                if (!AssetDatabase.IsValidFolder(folderPath))
                {
                    AssetDatabase.CreateFolder("Assets/_ProjectInsolence/Scripts/InventorySystem/Items/Items/ScriptableObjects", newItem.type.ToString() );
                }
